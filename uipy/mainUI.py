...
"")
        ...
        self.vbox_apps = QtWidgets.QVBoxLayout()
        self.vbox_apps.setObjectName("vbox_apps")
        self.hbox_apps_lbl_container = QtWidgets.QHBoxLayout()
        self.hbox_apps_lbl_container.setObjectName("hbox_apps_lbl_container")
        self.lbl_apps = QtWidgets.QLabel(self.settings_tab)
        self.lbl_apps.setObjectName("lbl_apps")
        self.hbox_apps_lbl_container.addWidget(self.lbl_apps)
        self.vbox_apps.addLayout(self.hbox_apps_lbl_container)
        self.hbox_apps_settings = QtWidgets.QHBoxLayout()
        self.hbox_apps_settings.setObjectName("hbox_apps_settings")
        self.btn_export_apps = QtWidgets.QPushButton(self.settings_tab)
        self.btn_export_apps.setStyleSheet("max-width: 180px;\n"
"min-width: 180px;")
        self.btn_export_apps.setObjectName("btn_export_apps")
        self.hbox_apps_settings.addWidget(self.btn_export_apps)
        self.btn_import_apps = QtWidgets.QPushButton(self.settings_tab)
        self.btn_import_apps.setStyleSheet("max-width: 180px;\n"
"min-width: 180px;")
        self.btn_import_apps.setObjectName("btn_import_apps")
        self.hbox_apps_settings.addWidget(self.btn_import_apps)
        self.vbox_apps.addLayout(self.hbox_apps_settings)
        self.verticalLayout.addLayout(self.vbox_apps)
        self.line_2 = QtWidgets.QFrame(self.settings_tab)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Plain)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setObjectName("line_2")
        self.verticalLayout.addWidget(self.line_2)
        self.vbox_notes_settings = QtWidgets.QVBoxLayout()
        self.vbox_notes_settings.setObjectName("vbox_notes_settings")
        self.hbox_notes_settings = QtWidgets.QHBoxLayout()
        self.hbox_notes_settings.setObjectName("hbox_notes_settings")
        self.lbl_notes_settings = QtWidgets.QLabel(self.settings_tab)
        self.lbl_notes_settings.setObjectName("lbl_notes_settings")
        self.hbox_notes_settings.addWidget(self.lbl_notes_settings)
        self.vbox_notes_settings.addLayout(self.hbox_notes_settings)
        self.hbox_notes_settings_container = QtWidgets.QHBoxLayout()
        self.hbox_notes_settings_container.setObjectName("hbox_notes_settings_container")
        self.btn_export_notes = QtWidgets.QPushButton(self.settings_tab)
        self.btn_export_notes.setStyleSheet("max-width: 180px;\n"
"min-width: 180px;")
        self.btn_export_notes.setObjectName("btn_export_notes")
        self.hbox_notes_settings_container.addWidget(self.btn_export_notes)
        self.btn_import_notes = QtWidgets.QPushButton(self.settings_tab)
        self.btn_import_notes.setStyleSheet("max-width: 180px;\n"
"min-width: 180px;")
        self.btn_import_notes.setObjectName("btn_import_notes")
        self.hbox_notes_settings_container.addWidget(self.btn_import_notes)
        self.vbox_notes_settings.addLayout(self.hbox_notes_settings_container)
        self.verticalLayout.addLayout(self.vbox_notes_settings)
        ...
        self.btn_reset.setMinimumSize(QtCore.QSize(194, 0))
        self.btn_reset.setStyleSheet("max-width: 180px;\n"
"min-width: 180px;")
        self.btn_reset.setObjectName("btn_reset")
        self.hbox_save.addWidget(self.btn_reset)
        self.btn_save = QtWidgets.QPushButton(self.settings_tab)
        self.btn_save.setMinimumSize(QtCore.QSize(194, 0))
        self.btn_save.setStyleSheet("max-width: 180px;\n"
"min-width: 180px;")
    ...
    def retranslateUi(self, Runner):
        ...
        self.lbl_apps.setText(_translate("Runner", "Apps:"))
        self.btn_export_apps.setText(_translate("Runner", "Export Apps"))
        self.btn_import_apps.setText(_translate("Runner", "Import Apps"))
        self.lbl_notes_settings.setText(_translate("Runner", "Notes:"))
        self.btn_export_notes.setText(_translate("Runner", "Export Notes"))
        self.btn_import_notes.setText(_translate("Runner", "Import Notes"))
